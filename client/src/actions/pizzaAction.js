...
export const getAllPizzas = () => async(dispatch) => {
    ...
    try {
        ...
        dispatch({type:'GET_PIZZAS_SUCCESS',payload : response.data });//response me jo bhi data aya payload me save kr liya
    } catch (err) {
        dispatch({type:'GET_PIZZAS_FAIL',payload : err });//response me jo bhi error aya payload me error object me save krnge ,iske liye err directly pass kiya
    }
}
