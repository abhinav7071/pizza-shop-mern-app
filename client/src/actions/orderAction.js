...
export const placeOrder = (token,subTotal) => async(dispatch,getState) => {
    ...
    const cartItems = getState().cartReducer.cartItems;//user k cartitems get kiye
    const subTotalVal = subTotal.subTotal;
    try {
        const response = await axios.post(`/api/orders/placeorder`,{token,subTotalVal,currentUser,cartItems});
